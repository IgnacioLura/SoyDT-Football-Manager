...
public sealed partial class NativeGameEngine
{
    ...
    public IReadOnlyList<LineupPlayer> GetTeamLineup(GameHandleSafeHandle game, uint teamId)
    {
        bool addedRef = false;
        try
        {
            ...
            return NativeStringMarshal.ReadEnvelope<IReadOnlyList<LineupPlayer>>(resultPtr);
        }
        finally
        {
